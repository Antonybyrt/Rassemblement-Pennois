...
const ListeElectorale: React.FC = () => {
  ...
  return (
    <>
      <CanonicalRedirect expectedPath="/equipe-de-campagne" />
      <SEOHead
        title={SEO_CONFIG.pages.equipe.title}
        description={SEO_CONFIG.pages.equipe.description}
        canonicalUrl={SEO_CONFIG.pages.equipe.canonicalUrl}
      />
